        ...
        <div ref={ref}>
            ...
            <div className="page">
                ...
                <div className="center-middle">
                    <h3>OWNER & BORROWER</h3>
                    <div>
                        <p>
                            Name &amp; Address: <strong>{formData.owner_name}</strong>
                        </p>
                        <p>
                            G.No. <strong>{formData.gut_no}</strong>
                        </p>
                        <p>
            ...
            <div className="page">
                ...
                <div className=".center-middle">
                    ...
                    <p>Respected Sir,</p>
                    <p className="indent">
                        After independent site visit to  {formData.property_type} {"  "}  G.No. {formData.gut_no} ,{" "}
                    ...
                    <p className="valuation">
                        So total fair market value of {formData.property_type} {"  "} G.No.
                ...
                <div className="container ">
                    ...
                    <table className="property-table">
                        <tbody>
                            ...
                            <tr>
                                <th>Area of {formData.property_type} of G.No.{formData.gut_no}</th>
                                <td>{formData.area}</td>
                            </tr>
                            <tr>
                                <th>Shape</th>
                ...
                <div className="container ">
                    ...
                    <table className="details-table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{formData.document_inspected}</td>
                            </tr>
                        </tbody>
                    </table>
                    <br></br>
                    ...
                    {formData.guts &&
                        ...
                        formData.guts.map((gut, index) => {
                            const gutNoKey = Object.keys(gut).find((k) =>
                                k.startsWith("gut_no")
                            );
                            return (
                                <div key={index} style={{ marginBottom: "20px" }}>
                                    <h2>Boundaries of G.No. {gut[gutNoKey]}</h2>
            ...
            <div className="page">
                ...
                <div>
                    ...
                    <p>
                        Property in the form of {formData.property_type}. Type of soil is {formData.surface_type}. Presently {formData.crop} is growing on it. Water Supply {formData.water}. Property Situated at {formData.location}
                    </p>
                </div>
